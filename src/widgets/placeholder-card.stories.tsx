...
import { PlaceholderCard } from "@/client";
import { Button } from "@/client";
import Link from "next/link";

const meta: Meta<typeof PlaceholderCard> = {
  title: "Widgets / Placeholder Card",
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "A placeholder card component for displaying empty states, errors, or unavailable content with customizable title, subtitle, and action buttons.",
      },
    },
  },
  tags: ["autodocs"],
