...
function Textarea({
  ...
  return (
    <textarea
      ...
      aria-labelledby={ariaLabelledBy}
      className={cn(
        "text-foreground placeholder:text-muted-foreground/50 selection:bg-primary selection:text-primary-foreground border-input bg-card dark:bg-input/10 hover:bg-input/20 focus:bg-input/20 flex min-h-[80px] w-full min-w-0 rounded-md border px-2 py-1 text-sm shadow-xs transition-[color,box-shadow] outline-none disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 md:text-sm",
