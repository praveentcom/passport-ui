    ...
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: cn(
          ...
          captionLayout === "label"
            ? "text-xs"
            : "rounded-md pl-2 pr-1 flex items-center gap-2 text-xs h-6 [&>svg]:text-muted-foreground [&>svg]:size-3.5",
