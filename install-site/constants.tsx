...
export const SITE_CONFIG = {
  ...
  images: {
    openGraph: 'https://storage.googleapis.com/praveentcom-projects/passport-ui/open_graph%402x.png',
...
export const INSTALLATION_PAGE_DATA = createPageStructuredData({
  ...
  description: "Complete installation guide for Passport UI - a sleek and compact React UI component library built with Tailwind CSS, Radix UI, and Framer Motion.",
...
export const COLORS_PAGE_DATA = createPageStructuredData({
  ...
  description: "Complete color system documentation for Passport UI component library. Explore design colors, semantic colors, component colors, and chart colors with automatic light/dark theme support.",
  ...
  mainEntity: {
    ...
    "description": "Comprehensive guide to Passport UI's color system built on OKLCH color space for better color management and automatic light/dark theme support.",
    "author": {
      "@type": "Person",
      "name": SITE_CONFIG.author.name,
      "url": SITE_CONFIG.author.url
...
export const getSidebarMenuItems = (activePath: string): SidebarContainerMenuItem[] => {
